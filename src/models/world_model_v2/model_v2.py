...
class WorldModelV2(nn.Module):
    ...
    def forward(
        ...
        gt_depths : (B, T, 1, H_low, W_low) or None, optional
            DIAGNOSTIC ONLY. If provided, overrides the *predicted*
            depth used for warping/residual/mask with ground-truth
            depth (already resized to the low-res feature grid this
            model predicts depth at). The model still predicts depth
